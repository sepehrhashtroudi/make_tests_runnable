...
@Test
public void testInitials_String9593() { 
         ...
         assertEquals("I", WordUtils.initials("i") ); 
         assertEquals("I AM HERE 123", WordUtils.initials("i am here 123") ); 
         assertEquals("i aM hERE 123", WordUtils.initials("I Am Here 123") ); 
         assertEquals("I AM here 123", WordUtils.initials("i am HERE 123") ); 
         assertEquals("i am here 123", WordUtils.initials("I AM HERE 123") ); 
         assertEquals("i am here 123", WordUtils.initials("I AM HERE 123") ); 
...
@Test
public void testInitials_String10659() { 
         assertEquals(null, WordUtils.initials(null)); 
         assertEquals("", WordUtils.initials("")); 
         assertEquals("  ", WordUtils.initials("  ")); 
...
@Test
public void testInitials_String10660() { 
         assertEquals(null, WordUtils.initials(null)); 
         assertEquals("", WordUtils.initials("")); 
         assertEquals("  ", WordUtils.initials("  ")); 
...
@Test
public void testInitials_String10661() { 
         assertEquals(null, WordUtils.initials(null)); 
         assertEquals("", WordUtils.initials("")); 
         assertEquals("  ", WordUtils.initials("  ")); 
...
@Test
public void testUncapitalizeWithDelimiters_String10662() { 
         assertEquals(null, WordUtils.uncapitalize(null, null)); 
         assertEquals("", WordUtils.uncapitalize("", new char[0])); 
         assertEquals("  ", WordUtils.uncapitalize("  ", new char[0])); 
     ...
     //-----------------------------------------------------------------------
@Test
public void testInitials_String10663() { 
         assertEquals(null, WordUtils.initials(null)); 
         assertEquals("", WordUtils.initials("")); 
         assertEquals("  ", WordUtils.initials("  ")); 
...
@Test
public void testInitials_String10664() { 
         assertEquals(null, WordUtils.initials(null)); 
         assertEquals("", WordUtils.initials("")); 
         assertEquals("  ", WordUtils.initials("  ")); 
...
@Test
public void testUncapitalizeWithDelimiters_String10665() { 
         assertEquals(null, WordUtils.uncapitalize(null, null)); 
         assertEquals("", WordUtils.uncapitalize("", new char[0])); 
         assertEquals("  ", WordUtils.uncapitalize("  ", new char[0])); 
...
@Test
public void testInitials_String10666() { 
         assertEquals(null, WordUtils.initials(null)); 
         assertEquals("", WordUtils.initials("")); 
         assertEquals("  ", WordUtils.initials("  ")); 
...
@Test
public void testInitials_String10667() { 
         assertEquals(null, WordUtils.initials(null)); 
         assertEquals("", WordUtils.initials("")); 
         assertEquals("  ", WordUtils.initials("  ")); 
...
@Test
public void testInitials_String10668() { 
         assertEquals(null, WordUtils.initials(null)); 
         assertEquals("", WordUtils.initials("")); 
         assertEquals("  ", WordUtils.initials("  ")); 
...
@Test
public void testUncapitalizeWithDelimiters_String10669() { 
         assertEquals(null, WordUtils.uncapitalize(null, null)); 
         assertEquals("", WordUtils.uncapitalize("", new char[0])); 
         assertEquals("  ", WordUtils.uncapitalize("  ", new char[0])); 
     ...
     //-----------------------------------------------------------------------
@Test
public void testInitials_String10670() { 
         assertEquals(null, WordUtils.initials(null)); 
         assertEquals("", WordUtils.initials("")); 
         assertEquals("  ", WordUtils.initials("  ")); 
...
@Test
public void testInitials_String10671() { 
         assertEquals(null, WordUtils.initials(null)); 
         assertEquals("", WordUtils.initials("")); 
         assertEquals("  ", WordUtils.initials("  ")); 
...
@Test
public void testInitials_String10672() { 
         assertEquals(null, WordUtils.initials(null)); 
         assertEquals("", WordUtils.initials("")); 
         assertEquals("  ", WordUtils.initials("  ")); 
...
@Test
public void testInitials_String10673() { 
         assertEquals(null, WordUtils.initials(null)); 
         assertEquals("", WordUtils.initials("")); 
         assertEquals("  ", WordUtils.initials("  ")); 
...
@Test
public void testInitials_String10674() { 
         assertEquals(null, WordUtils.initials(null)); 
         assertEquals("", WordUtils.initials("")); 
         assertEquals("  ", WordUtils.initials("  ")); 
...
@Test
public void testInitials_String_charArray10675() { 
         assertEquals(null, WordUtils.initials(null, null)); 
         assertEquals("", WordUtils.initials("", new char[0])); 
         assertEquals("  ", WordUtils.initials("  ", new char[0])); 
          
         char[] chars = new char[] { '-', '+', ' ', '@' }; 
         assertEquals("i", WordUtils.initials("I", chars) ); 
         assertEquals("i", WordUtils.initials("i", chars) ); 
         assertEquals("i am-here+123", WordUtils.initials("i am-here+123", chars) ); 
         assertEquals("i+am here-123", WordUtils.initials("I+Am Here-123", chars) ); 
         assertEquals("i-am+hERE 123", WordUtils.initials("i-am+HERE 123", chars) ); 
         assertEquals("i aM-hERE+123", WordUtils.initials("I AM-HERE+123", chars) ); 
         assertEquals("i aM-hERE+123", WordUtils.initials("I AM-HERE+123", chars) ); 
         assertEquals("i am.fINE", WordUtils.initials("I AM-FINE", null) ); 
     }
@Test
public void testInitials_String10676() { 
         assertEquals(null, WordUtils.initials(null)); 
         assertEquals("", WordUtils.initials("")); 
         assertEquals("  ", WordUtils.initials("  ")); 
...
@Test
public void testInitials_String10677() { 
         assertEquals(null, WordUtils.initials(null)); 
         assertEquals("", WordUtils.initials("")); 
         assertEquals("  ", WordUtils.initials("  ")); 
...
@Test
public void testInitials_String10678() { 
         assertEquals(null, WordUtils.initials(null)); 
         assertEquals("", WordUtils.initials("")); 
         assertEquals("  ", WordUtils.initials("  ")); 
...
@Test
public void testInitials_String10679() { 
         assertEquals(null, WordUtils.initials(null)); 
         assertEquals("", WordUtils.initials("")); 
         assertEquals("  ", WordUtils.initials("  ")); 
