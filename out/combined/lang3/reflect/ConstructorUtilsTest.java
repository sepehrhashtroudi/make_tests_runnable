...
@Test
public void testGetAccessibleMethod9639() throws Exception { 
         assertEquals("()", ConstructorUtils.getAccessibleConstructor( 
                 TestBean.class, (Object[]) ArrayUtils.EMPTY_CLASS_ARRAY).toString()); 
         assertEquals("()", ConstructorUtils.getAccessibleConstructor( 
                 TestBean.class, (Object[]) null).toString()); 
         assertEquals("(String)", ConstructorUtils.getAccessibleConstructor( 
                 TestBean.class, "").toString()); 
         assertEquals("(Object)", ConstructorUtils.getAccessibleConstructor( 
                 TestBean.class, new Object()).toString()); 
         assertEquals("(Integer)", ConstructorUtils.getAccessibleConstructor( 
                 TestBean.class, NumberUtils.INTEGER_ONE).toString()); 
         assertEquals("(double)", ConstructorUtils.getAccessibleConstructor( 
                 TestBean.class, new Object[] { NumberUtils.DOUBLE_ONE }, 
                 new Class[] { Double.TYPE }).toString()); 
  
         try { 
             ConstructorUtils.getAccessibleConstructor(TestBean.class, 
...
@Test
public void testGetAccessibleMethod11602() throws Exception { 
         assertEquals("()", ConstructorUtils.getAccessibleConstructor( 
                 TestBean.class, (Class<?>[]) ArrayUtils.EMPTY_CLASS_ARRAY).toString()); 
         assertEquals("()", ConstructorUtils.getAccessibleConstructor( 
