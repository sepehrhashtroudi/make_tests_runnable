...
@Test 
     public void testGetSet9588() { 
         ...
         mutNum.setValue(new MutableDouble(4d)); 
         assertEquals(4d, mutNum.doubleValue(), 0.0001d); 
         assertEquals(Double.valueOf(5d), mutNum.getValue()); 
     } 
  

@Test 
     public void testGetSet9608() { 
         final MutableDouble mutNum = new MutableDouble(0d); 
         assertEquals(0d, new MutableDouble().doubleValue(), 0.0001d); 
         assertEquals(Double.valueOf(0), new MutableDouble().getValue()); 
...
@Test 
     public void testAddValueObject9685() { 
         final MutableDouble mutNum = new MutableDouble(1); 
...
@Test 
     public void testPrimitiveValues10442() { 
         final MutableDouble mutNum = new MutableDouble(1.7); 
...
@Test 
     public void testGetSet10443() { 
         final MutableDouble mutNum = new MutableDouble(0d); 
         assertEquals(0d, new MutableDouble().doubleValue(), 0.01d); 
         assertEquals(Double.valueOf(0), new MutableDouble().getValue()); 
          
         mutNum.setValue(1); 
         assertEquals(1d, mutNum.doubleValue(), 0.01d); 
         assertEquals(Double.valueOf(1d), mutNum.getValue()); 
          
         mutNum.setValue(Double.valueOf(2d)); 
         assertEquals(2d, mutNum.doubleValue(), 0.01d); 
         assertEquals(Double.valueOf(2d), mutNum.getValue()); 
          
         mutNum.setValue(new MutableDouble(3d)); 
         assertEquals(3d, mutNum.doubleValue(), 0.01d); 
         assertEquals(Double.valueOf(3d), mutNum.getValue()); 
     } 
  

@Test 
     public void testPrimitiveValues10444() { 
         final MutableDouble mutNum = new MutableDouble(1.7); 
...
@Test 
     public void testAddValueObject12546() { 
         final MutableDouble mutNum = new MutableDouble(1); 
         mutNum.add(Double.valueOf(1.1d)); 
