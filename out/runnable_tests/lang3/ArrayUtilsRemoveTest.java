...
@Test 
     public void testRemoveElementByte9656() { 
         byte[] array; 
...
@Test 
     public void testRemoveElementByteArray11924() { 
         byte[] array; 
         array = ArrayUtils.removeElement((byte[]) null, (byte) 1); 
         assertNull(array); 
         array = ArrayUtils.removeElement(ArrayUtils.EMPTY_BYTE_ARRAY, (byte) 1); 
...
@Test 
     public void testRemoveElementByteArray11925() { 
         byte[] array; 
...
@Test 
     public void testRemoveElementByte11926() { 
         byte[] array; 
         array = ArrayUtils.removeElement((byte[]) null, (byte) 1); 
         assertNull(array); 
         array = ArrayUtils.removeElement(ArrayUtils.EMPTY_BYTE_ARRAY, (byte) 1); 
...
@Test 
     public void testRemoveElementByte11927() { 
         byte[] array; 
         array = ArrayUtils.removeElement((byte[]) null, (byte) 1); 
         assertNull(array); 
         array = ArrayUtils.removeElement(ArrayUtils.EMPTY_BYTE_ARRAY, (byte) 1); 
...
@Test 
     public void testRemoveElementByte11928() { 
         byte[] array; 
         array = ArrayUtils.removeElement((byte[]) null, (byte) 1); 
         assertNull(array); 
         array = ArrayUtils.removeElement(ArrayUtils.EMPTY_BYTE_ARRAY, (byte) 1); 
...
@Test 
     public void testRemoveElementByte11929() { 
         byte[] array; 
         array = ArrayUtils.removeElement((byte[]) null, (byte) 1); 
         assertNull(array); 
         array = ArrayUtils.removeElement(ArrayUtils.EMPTY_BYTE_ARRAY, (byte) 1); 
