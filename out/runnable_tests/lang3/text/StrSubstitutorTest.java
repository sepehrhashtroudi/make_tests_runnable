...
@Test 
     ...
     private void doTestReplace(final String expectedResult, final String replaceTemplate, final boolean substring) { 
         ...
         assertEquals(
@Test 
     public void testSamePrefixAndSuffix12053() { 
         final Map<String, String> map = new HashMap<String, String>(); 
         map.put("greeting", "Hello"); 
         map.put(" there ", "XXX"); 
         map.put("name", "commons"); 
...
@Test 
     public void testSamePrefixAndSuffix12057() { 
         final Map<String, String> map = new HashMap<String, String>(); 
         map.put("greeting", "Hello"); 
         map.put(" there ", "XXX"); 
         map.put("name", "commons"); 
...
@Test 
     public void testSamePrefixAndSuffix12062() { 
         final Map<String, String> map = new HashMap<String, String>(); 
         map.put("greeting", "Hello"); 
         map.put(" there ", "XXX"); 
         map.put("name", "commons"); 
...
@Test 
     public void testSamePrefixAndSuffix12068() { 
         final Map<String, String> map = new HashMap<String, String>(); 
         map.put("greeting", "Hello"); 
         map.put(" there ", "XXX"); 
         map.put("name", "commons"); 
...
@Test 
     public void testSamePrefixAndSuffix12086() { 
         final Map<String, String> map = new HashMap<String, String>(); 
         map.put("greeting", "Hello"); 
         map.put(" there ", "XXX"); 
         map.put("name", "commons"); 
